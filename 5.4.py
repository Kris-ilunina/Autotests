...
def scrabble(word):
    """
    Создаем словарь, где каждая буква соответствует количеству очков, и считаем сумму очков в слове
    :param word: исходное слово
    :return: количество очков за каждую букву в слове
    """
    dict = {1: 'авеёинорст',
            2: "дклмпу",
            3: 'бгья',
            ...
            10: 'щ',
            15: 'ъ'}
    points = sum([k for i in word for k, v in dict.items() if i in v])
    return points
