...
def repeats(our_str):
    """
    Создаем стрроку, которая показывает сколько раз каждый символ уже встречался в формате _n
    :param our_str: исходная строка
    :return: строка с количеством повторений символов
    """
    new_str = ''
    for i in our_str:
        if new_str.count(i) == 0:
            ...
            new_str += f'{i}_{new_str.count(i) + 1}'
    return new_str
