...
def everything_for_your_cat(cats_data):
    """
    Выводим информацию о владельце и его питомцах в формате: Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    :param cats_data: списки кортежей
    :return: структурированная информация о владельце и питомцах
    """
    dict_cats = {}
